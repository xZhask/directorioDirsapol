...
const btnUpdate = document.querySelector("#updateContacto");
...
formContacto.addEventListener("submit", async (e) => {
  ...
  if (retorno.rpta === "Ok")
    msgAlert("success", "Se registró correctamente", retorno.mensaje);
  else msgAlert("error", "Ocurrió un inconveniente", retorno.mensaje);
  btnUpdate.innerHTML = `<i class="fa-solid fa-floppy-disk"></i> Guardar`;
...
$(document).on("keypress", ".phone", (e) => {
  return isNumber(e);
});
$(document).on("keypress", "#correoIpress", (e) => {
  return isSpace(e);
});
